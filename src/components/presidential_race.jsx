    ...
    axios.post('/api/presidents', { data: record })
      .then((response) => {
        if (response.data.success) {
          ...
          toastr.success('president record submitted to the blockchain. It might take a few minutes for record to be shown below.');
        } else {
          // console.log(response.data);
          // toastr.error(response.data.message);
          response.data.validations.messages.map((message) => {
                          ...
                          <div className="col-6">
                            <div className="row">
                                <div className="col-lg-12 col-md-12">
                                    <label>Name</label>
                                    <input placeholder="Candidate's Name" value={this.state.Name } className="form-control" onChange={this.handleChange.bind(this, 'Name')} /><br />
                                </div>
                                <div className="col-lg-12 col-md-12">
                                    <label>Party</label>
                                    <input placeholder="Candidate's Party" value={this.state.Party } className="form-control" onChange={this.handleChange.bind(this, 'Party')} /><br />
                                </div>
                            </div>
